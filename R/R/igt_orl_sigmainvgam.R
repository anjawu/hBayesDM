#' @templateVar MODEL_FUNCTION igt_orl_sigmainvgam
#' @templateVar CONTRIBUTOR \href{https://ccs-lab.github.io/team/nate-haines/}{Nate Haines} <\email{haines.175@@osu.edu}>, \href{https://github.com/anjawu}{Anja Wu} <\email{anjaradakovic33@@gmail.com}>
#' @templateVar TASK_NAME Iowa Gambling Task
#' @templateVar TASK_CODE igt
#' @templateVar TASK_CITE (Ahn et al., 2008)
#' @templateVar MODEL_NAME Outcome-Representation Learning Model updated with inverse gamma priors on hyperparameter sigmas
#' @templateVar MODEL_CODE orl_sigmainvgam
#' @templateVar MODEL_CITE (Haines et al., 2018)
#' @templateVar MODEL_TYPE Hierarchical model with sigma hyperparameter prior updated to be Inverse Gamma distribution
...
igt_orl_sigmainvgam <- hBayesDM_model(
  task_name       = "igt",
