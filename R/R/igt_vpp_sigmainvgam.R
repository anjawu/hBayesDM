#' @templateVar MODEL_FUNCTION igt_vpp_sigmainvgam
...
#' @templateVar MODEL_NAME Value-Plus-Perseverance updated with inverse gamma priors on hyperparameter sigmas
#' @templateVar MODEL_CODE vpp_sigmainvgam
...
igt_vpp_sigmainvgam <- hBayesDM_model(
  task_name       = "igt",
