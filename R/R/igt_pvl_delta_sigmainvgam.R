#' @templateVar MODEL_FUNCTION igt_pvl_delta_sigmainvgam
#' @templateVar CONTRIBUTOR \href{https://github.com/anjawu}{Anja Wu} <\email{anjaradakovic33@@gmail.com}>
#' @templateVar TASK_NAME Iowa Gambling Task
#' @templateVar TASK_CODE igt
#' @templateVar TASK_CITE (Ahn et al., 2008)
#' @templateVar MODEL_NAME Prospect Valence Learning (PVL) Delta updated with inverse gamma priors on hyperparameter sigmas
#' @templateVar MODEL_CODE pvl_delta_sigmainvgam
...
igt_pvl_delta_sigmainvgam <- hBayesDM_model(
  task_name       = "igt",
