...
__all__ = ['igt_orl_sigmainvgam']


class IgtOrlSigmainvgam(TaskModel):
    def __init__(self, **kwargs):
        super().__init__(
            task_name='igt',
            model_name='orl_sigmainvgam',
            model_type='',
            data_columns=(
                'subjID',
                'choice',
...
def igt_orl_sigmainvgam(
    ...
    """Iowa Gambling Task - Outcome-Representation Learning Model updated with inverse gamma priors on hyperparameter sigmas
    ...
    using Outcome-Representation Learning Model updated with inverse gamma priors on hyperparameter sigmas [Haines2018]_ with the following parameters:
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('igt_orl_sigmainvgam').
    ...
    .. code:: python
        ...
        output = igt_orl_sigmainvgam(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)
