...
__all__ = ['igt_pvl_delta_sigmainvgam']


class IgtPvlDeltaSigmainvgam(TaskModel):
    def __init__(self, **kwargs):
        super().__init__(
            task_name='igt',
            model_name='pvl_delta_sigmainvgam',
            model_type='',
            data_columns=(
                'subjID',
                'choice',
...
def igt_pvl_delta_sigmainvgam(
    ...
    """Iowa Gambling Task - Prospect Valence Learning (PVL) Delta updated with inverse gamma priors on hyperparameter sigmas

    Hierarchical model with sigma hyperparameter prior updated to be Inverse Gamma distribution Bayesian Modeling of the Iowa Gambling Task [Ahn2008]_
    using Prospect Valence Learning (PVL) Delta updated with inverse gamma priors on hyperparameter sigmas [Ahn2008]_ with the following parameters:
    ...
    .. codeauthor:: Anja Wu <anjaradakovic33@gmail.com>
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('igt_pvl_delta_sigmainvgam').
    ...
    .. code:: python
        ...
        from hbayesdm.models import igt_pvl_delta_sigmainvgam

        # Run the model and store results in "output"
        output = igt_pvl_delta_sigmainvgam(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)
