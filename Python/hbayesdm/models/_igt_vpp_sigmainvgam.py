...
__all__ = ['igt_vpp_sigmainvgam']


class IgtVppSigmainvgam(TaskModel):
    def __init__(self, **kwargs):
        super().__init__(
            task_name='igt',
            model_name='vpp_sigmainvgam',
            model_type='',
            data_columns=(
                'subjID',
                'choice',
...
def igt_vpp_sigmainvgam(
    ...
    """Iowa Gambling Task - Value-Plus-Perseverance updated with inverse gamma priors on hyperparameter sigmas
    ...
    using Value-Plus-Perseverance updated with inverse gamma priors on hyperparameter sigmas [Worthy2013]_ with the following parameters:
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('igt_vpp_sigmainvgam').
    ...
    .. code:: python
        ...
        output = igt_vpp_sigmainvgam(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)
